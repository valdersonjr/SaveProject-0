...
import { getMonthName } from './service';
import { findMaxMin } from '../../components/forecastInformations/service';
...
export default function Forecast({
  ...
  const api = axios.create({
    baseURL: `https://api.openweathermap.org/data/2.5/forecast?lat=${coordinates.lat}&lon=${coordinates.lng}&lang=pt_br&appid=${openWheatherApiKey}`,
  });
